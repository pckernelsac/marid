...
export function RadiographsPage() {
  ...
  if (selected) {
    return (
      <div className="space-y-4">
        ...
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">Radiografías</h1>
          <p className="text-sm text-muted-foreground">{selected.name}</p>
        </div>
        <RadiographGallery patientId={selected.id} />
      </div>
    );
  }
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Selecciona un paciente para ver sus radiografías.
        </p>
      </div>
